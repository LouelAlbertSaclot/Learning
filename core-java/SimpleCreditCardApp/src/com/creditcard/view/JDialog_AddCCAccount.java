...
import com.creditcard.model.customer.CCustomerDetails;
...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
	...
	public JDialog_AddCCAccount(CCApplicationForm parent)
	{
		super(parent);
	...
	{
		custDetails = new CCustomerDetails();
		...
		int cardnum = Integer.parseInt(JTextField_CCNR.getText());
		cardDetails.setCCardNum(cardnum);
		cardDetails.setExpDate(JTextField_ExpDate.getText());
       
		if (JRadioButton_Gold.isSelected())
		{
			cardDetails.setType("G");
		} else if (JRadioButton_Silver.isSelected())
		{
			cardDetails.setType("S");
		} else
		{
			cardDetails.setType("B");
		}
