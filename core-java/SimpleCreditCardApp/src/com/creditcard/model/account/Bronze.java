...
{
	private final BigDecimal MP = new BigDecimal(0.22d);
	private final BigDecimal MI = new BigDecimal(0.20d);
	
	public Bronze(int acctNum, double amount)
	{
	...
	public String getReport()
	{
		...
		BigDecimal common = prevBal.subtract(new BigDecimal(totalCredits));
		
		BigDecimal part1 = common.add(new BigDecimal(totalCharges));
		BigDecimal part2 = MI.multiply(common);
